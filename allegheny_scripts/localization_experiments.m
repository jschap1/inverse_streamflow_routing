...
load('./allegheny_data/setup/setup-2-gage.mat');
...
% PW13 ISR
    tic
    [post_runoff_both_gages] = ISR_PW13(runoff_init, HH, gage_w_error, s, 'const_diag', totsd, R);
    [post_runoff_ds_gage] = ISR_PW13(runoff_init, HH(1,:,:), gage_w_error(:,1), s, 'const_diag', totsd, R);
    [post_runoff_us_gage] = ISR_PW13(runoff_init, HH(2,:,:), gage_w_error(:,2), s, 'const_diag', totsd, R);
...
% Y20 ISR
    ...
    post_runoff_both_gages = ISR_Y20(runoff_init, HH, gage_w_error, s, basin, optionsfile, L, T, rho_thres);
    post_runoff_ds_gage = ISR_Y20(runoff_init, HH(1,:,:), gage_w_error(:,1), s, basin, optionsfile, L, T, rho_thres);
    post_runoff_us_gage = ISR_Y20(runoff_init, HH(2,:,:), gage_w_error(:,2), s, basin, optionsfile, L, T, rho_thres);    
    toc
end
...
gi = (k+1):nt-(k+1);
plt_ISR_results_overview(basin, tmpa_runoff_prior', post_runoff_both_gages', truth, tv, gi)
...
% E6.mean_prior_runoff = mean(E6.both.prior_runoff_ens,3);
% E6.us.truth.true_runoff
% 
% [nse1, kge, rmse, nsemap_us] = plot_gofmaps(basin, E6.us.mean_post_runoff', E6.us.truth.true_runoff, gi);
% [nse1, kge, rmse, nsemap_ds] = plot_gofmaps(basin, E6.ds.mean_post_runoff', E6.us.truth.true_runoff, gi);
% [nse1, kge, rmse, nsemap_both] = plot_gofmaps(basin, E6.both.mean_post_runoff', E6.us.truth.true_runoff, gi);
% [nse1, kge, rmse, nsemap_prior] = plot_gofmaps(basin, E6.mean_prior_runoff', E6.us.truth.true_runoff, gi);
...
[nse1, kge, rmse, nsemap_prior] = plot_gofmaps(basin, runoff_init, truth.total_runoff, gi);
...
% This is the figure, but it is getting flipped around....
...
sub1runoff.prior = get_runoff_for_cells_in_subdomain(runoff_init, subdomain1_index, basin);
sub2runoff.prior = get_runoff_for_cells_in_subdomain(runoff_init, subdomain2_index, basin);
