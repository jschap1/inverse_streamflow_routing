%% Running Y20 ISR for Cases 1, 2, 3.1, and 3.2
%
% 11/24/2023 JRS
% Implementing domain Y20 ISR for Allegheny basin using two gages
...
B = load('/home/jschap/Dropbox/ISR/inverse_streamflow_routing/allegheny_data/setup/setup-233-gage.mat');
...
%% Save results
save('./allegheny_data/results/outlet_only/Y20LM_m0a1L40T5_daily_5_unbiased_flat_alpha4_M1-500.mat', 'runoff_prior', 'post_runoff', ...
    'gage_w_error','post_stddev', 'prior_stddev', 'post_stddevQ','prior_stddevQ',...
    'tmpa_runoff_prior', 'nldas_runoff_true', 'prior_runoff_ens');
